    ...
    const fetchRound = async () => {
      try {
        ...
        data.questions.forEach((q) => {
          const status = data.participant?.questionStatus?.find(
    ...
    <div className="min-h-screen bg-gray-950 text-white flex flex-col">
      ...
      <header className="h-16 border-b border-gray-800 bg-gray-900 px-6 flex justify-between items-center">
        ...
        <div className="flex items-center gap-6">
          <div
            className={`px-4 py-2 rounded-lg font-mono font-bold text-xl ${
              timeLeft < 300
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="w-1/3 border-r border-gray-800 flex flex-col bg-gray-900/50">
          ...
          <div className="flex-1 overflow-y-auto p-6">
            ...
            <div className="prose prose-sm max-w-none mb-8 text-[var(--color-text-base)] prose-headings:text-[var(--color-text-base)] prose-strong:text-[var(--color-text-base)] prose-code:text-[var(--color-text-base)] prose-a:text-[var(--color-accent)] prose-pre:bg-[var(--color-surface2)] prose-pre:border prose-pre:border-[var(--color-text-base)]/[0.14]">
            ...
            <div className="space-y-4">
              ...
              {currentQuestion.testCases.map((tc, idx) => (
                <div
                  key={idx}
                  className="bg-gray-800 rounded-lg p-3 text-sm font-mono border border-gray-700"
                >
                  <div className="mb-2">
