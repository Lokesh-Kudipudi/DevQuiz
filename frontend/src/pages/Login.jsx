            ...
            <div className="relative z-10 w-full max-w-[400px] animate-[fadeUp_0.3s_ease_forwards]">
                ...
                <div className="bg-[var(--color-surface)] border border-[var(--color-text-base)]/[0.07] rounded-[12px] p-8">
                    ...
                    <div className="flex mb-6 border-b border-[var(--color-text-base)]/[0.07]">
                        <button
                            ...
                            className={`flex-1 pb-3 text-sm font-mono font-medium transition-colors border-b-2 ${
                                isLogin ? 'text-[var(--color-text-base)] border-[#7fff6e]' : 'text-[var(--color-muted)] border-transparent hover:text-[var(--color-text-base)]/[0.8]'
                            }`}
                        >
                            Sign In
                        </button>
                    ...
                    <form onSubmit={handleSubmit} className="flex flex-col gap-4 mb-6">
                        {!isLogin && (
                            <div>
                                <label className="block text-[var(--color-muted)] text-xs font-mono mb-1.5 uppercase tracking-wider">Name</label>
                                <input
                                    type="text"
                                    name="name"
                                    value={formData.name}
                                    ...
                                    required
                                    className="w-full bg-[var(--color-surface2)] border border-[var(--color-text-base)]/[0.07] rounded-lg px-4 py-3 text-sm text-[var(--color-text-base)] font-mono focus:outline-none focus:border-[#7fff6e] transition-colors"
                                />
                            </div>
                        )}
                        <div>
                            <label className="block text-[var(--color-muted)] text-xs font-mono mb-1.5 uppercase tracking-wider">Email</label>
                            <input
                                type="email"
                                name="email"
                        ...
                        <div>
                            <label className="block text-[var(--color-muted)] text-xs font-mono mb-1.5 uppercase tracking-wider">Password</label>
                            <input
                                type="password"
                                name="password"
                        ...
                        {!isLogin && (
                            <div>
                                <label className="block text-[var(--color-muted)] text-xs font-mono mb-1.5 uppercase tracking-wider">Confirm Password</label>
                                <input
                                    type="password"
                        ...
                        <button
                            type="submit"
                            className="mt-2 w-full bg-[#7fff6e] hover:bg-[#6be65d] text-[#0a0a0f] font-mono font-bold text-sm py-3 px-4 rounded-lg transition-all duration-150 hover:-translate-y-px cursor-pointer border-0"
                        >
                    ...
                    <div className="flex items-center gap-3 my-6">
                        ...
                        <span className="text-[10px] uppercase tracking-[2px] text-[var(--color-muted)] font-mono">Or</span>
                        <div className="flex-1 h-px bg-[var(--color-text-base)]/[0.07]" />
                    </div>
