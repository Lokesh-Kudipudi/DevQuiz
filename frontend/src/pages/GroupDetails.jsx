  ...
  const confirmDelete = async () => {
    ...
    try {
      if (type === "quiz") {
        ...
        setGroup((prev) => ({
          ...prev,
          codingRounds: prev.codingRounds.filter(
            (r) => r._id !== id,
          ),
        }));
        ...
        setGroup((prev) => ({
          ...prev,
          onlineAssessments: prev.onlineAssessments.filter(
            (a) => a._id !== id,
          ),
        }));
    ...
    <Layout>
        ...
        <div className="flex gap-3">
          ...
          <Button
            onClick={() => {
              const isWhitelisted =
                user?.email &&
                WHITELISTED_EMAILS.includes(user.email);
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          {group.onlineAssessments &&
          group.onlineAssessments.length > 0 ? (
            <div className="space-y-4 mb-8">
              {group.onlineAssessments.map((oa) => {
                const myParticipant = oa.participants?.find(
                  (p) =>
        ...
        <div className="space-y-4">
          ...
          <Card>
            ...
            {!collapsed.members && (
              <div className="mt-4 space-y-3 max-h-70 overflow-y-auto pr-1 custom-scrollbar">
          ...
          <Card>
            ...
            <div
              className={`mt-4 ${collapsed.leaderboard ? "hidden" : ""}`}
            >
