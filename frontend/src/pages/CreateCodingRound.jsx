...
const CreateCodingRound = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.post('/api/coding-rounds', {
                title,
                groupId,
                timeLimit,
                questions
    ...
    const handleGenerate = async () => {
        ...
        try {
            ...
            // Transform data if necessary, or directly set if format matches
            // Backend returns array of questions matching our structure
            setQuestions(data);
            setGenerationMode('manual'); // Switch back to manual to review
        } catch (err) {
            console.error(err);
                ...
                <Card>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        {generationMode === 'ai' ? (
                            ...
                            // Wrapper for manual coding questions list to keep logic clean
                        ...
                        </div> // End of manual mode wrapper
                        )}

                        <div className="flex justify-end pt-6 border-t border-gray-700">
                            <Button type="submit" disabled={loading} className="w-full md:w-auto">
                                {loading ? 'Creating...' : 'Create Coding Round'}
                            </Button>
                        </div>
                    </form>
                </Card>
