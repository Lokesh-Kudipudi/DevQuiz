...
const PistonRoundForm = ({ questions, setQuestions }) => {
  ...
  const removeTestCase = (qIndex, tIndex) => {
    ...
    if (newQuestions[qIndex].testCases.length > 1) {
      newQuestions[qIndex].testCases = newQuestions[
        qIndex
      ].testCases.filter((_, i) => i !== tIndex);
      setQuestions(newQuestions);
    }
  };
  ...
  return (
    <div className="mt-8">
      ...
      {generationMode === "ai" ? (
        <div className="bg-linear-to-br from-purple-900/20 to-gray-900 border border-purple-500/30 rounded-xl p-8 text-center space-y-6">
        ...
        <div className="space-y-6">
          {questions.map((question, qIndex) => (
            <div
              key={qIndex}
              className="bg-gray-800/50 p-6 rounded-xl border border-gray-700 mb-6"
            >
              ...
              <div className="space-y-1 mb-4">
                ...
                <textarea
                  ...
                  className="w-full px-4 py-2 bg-gray-900 border border-gray-700 rounded-lg text-white focus:outline-none focus:border-primary-500 min-h-25"
              ...
              <div className="space-y-1 mb-4">
                ...
                <textarea
                  ...
                  className="w-full px-4 py-2 bg-gray-950 border border-gray-700 rounded-lg text-gray-300 font-mono text-sm focus:outline-none focus:border-primary-500 min-h-25"
...
export default PistonRoundForm;
