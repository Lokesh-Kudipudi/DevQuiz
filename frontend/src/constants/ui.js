...
export const BUTTON_VARIANTS = {
  ...
  outline:
    ...
    "hover:bg-[var(--color-surface2)] focus:ring-[var(--color-text-base)]/10",

  ghost:
    "bg-transparent text-[var(--color-muted)] border border-[var(--color-text-base)]/[0.07] " +
    "hover:border-[var(--color-text-base)]/[0.14] hover:text-[var(--color-text-base)] focus:ring-[var(--color-text-base)]/10",
  ...
  secondary:
    "bg-[var(--color-surface2)] text-[var(--color-text-base)] border border-[var(--color-text-base)]/[0.07] " +
    "hover:border-[var(--color-text-base)]/[0.14] focus:ring-[var(--color-text-base)]/10",
};
...
export const CARD_BASE_STYLES =
  "bg-[var(--color-surface)] border border-[var(--color-text-base)]/[0.07] rounded-[12px] p-6";

export const CARD_HOVER_STYLES =
  "hover:border-[var(--color-text-base)]/[0.14] hover:-translate-y-0.5 " +
...
export const GROUP_CARD_STYLES =
  "relative bg-[var(--color-surface)] border border-[var(--color-text-base)]/[0.07] rounded-[12px] p-6 " +
...
export const SIDEBAR_CARD_STYLES =
  "bg-[var(--color-surface)] border border-[var(--color-text-base)]/[0.07] rounded-[12px] p-5 mb-4";
...
export const INPUT_BASE_STYLES =
  "w-full bg-[var(--color-bg)] border border-[var(--color-text-base)]/[0.07] rounded-lg " +
  "px-3.5 py-2.5 font-mono text-[13px] text-[var(--color-text-base)] " +
  "placeholder-[var(--color-muted)] outline-none " +
  "focus:border-[var(--color-text-base)]/[0.14] transition-colors duration-150 " +
...
export const INPUT_LABEL_STYLES =
  "block text-[10px] uppercase tracking-[1px] text-[var(--color-muted)] font-mono mb-2";
...
export const TAG_STYLES =
  "text-[10px] px-2 py-0.5 bg-[var(--color-surface2)] border border-[var(--color-text-base)]/[0.07] " +
  "rounded text-[var(--color-muted)] tracking-widest font-mono";
...
export const SECTION_LABEL_STYLES =
  ...
  "text-[var(--color-muted)] font-mono mb-4 " +
  "after:content-[''] after:flex-1 after:h-px after:bg-[var(--color-text-base)]/[0.07]";
...
export const SECTION_HEADING_STYLES =
  "font-['Syne',sans-serif] font-bold text-base text-[var(--color-text-base)] " +
...
export const QUIZ_ITEM_STYLES =
  "bg-[var(--color-surface)] border border-[var(--color-text-base)]/[0.07] rounded-[12px] " +
  "px-6 py-5 mb-3 flex items-center justify-between " +
  "hover:border-[var(--color-text-base)]/[0.14] transition-all duration-150 cursor-pointer";

export const QUIZ_ITEM_NAME_STYLES =
  "font-['Syne',sans-serif] font-semibold text-[15px] text-[var(--color-text-base)] " +
  "mb-2 leading-snug";
...
export const DIFFICULTY_LABEL_STYLES =
  "inline-flex items-center text-[10px] text-[var(--color-muted)] font-mono";
...
export const LB_ROW_STYLES =
  "flex items-center gap-3 px-3 py-2.5 rounded-lg bg-[var(--color-bg)] mb-1.5 " +
  "hover:bg-[var(--color-surface2)] transition-colors duration-100";
...
export const LB_TABLE_ROW_STYLES =
  ...
  "border border-[var(--color-text-base)]/[0.07] rounded-[10px] mb-2 px-4 py-3.5 items-center " +
  "hover:border-[var(--color-text-base)]/[0.14] hover:translate-x-1 transition-all duration-150";
...
export const LB_TABLE_HEADER_STYLES =
  ...
  "text-[10px] uppercase tracking-[1.5px] text-[var(--color-muted)] font-mono " +
  "border-b border-[var(--color-text-base)]/[0.07]";

export const RANK_BADGE = {
  1: "w-8 h-8 rounded-lg grid place-items-center text-[13px] font-semibold bg-[#ffcc44]/15 text-[#ffcc44]",
  2: "w-8 h-8 rounded-lg grid place-items-center text-[13px] font-semibold bg-[var(--color-text-base)]/[0.08] text-[#c0c0d0]",
  3: "w-8 h-8 rounded-lg grid place-items-center text-[13px] font-semibold bg-[#cd7f32]/10 text-[#cd7f32]",
  default: "w-8 h-8 rounded-lg grid place-items-center text-[13px] font-semibold bg-[var(--color-surface2)] text-[var(--color-muted)]",
};
...
export const PERF_CARD_STYLES =
  "bg-[var(--color-surface)] border border-[var(--color-text-base)]/[0.07] rounded-[12px] p-7 mb-8 " +
  "grid grid-cols-[1fr_auto] gap-6 items-center";

export const PERF_STAT_BOX_STYLES =
  "text-center p-4 bg-[var(--color-bg)] border border-[var(--color-text-base)]/[0.07] " +
...
export const INVITE_CODE_BLOCK_STYLES =
  "bg-[var(--color-bg)] border border-[var(--color-text-base)]/[0.07] rounded-lg px-4 py-3 " +
...
export const MEMBER_ITEM_STYLES =
  "flex items-center gap-2.5 p-2 rounded-lg hover:bg-[var(--color-surface2)] transition-colors cursor-default";

export const MEMBER_NAME_STYLES = "text-xs font-mono text-[var(--color-text-base)]";
...
export const EMPTY_STATE_STYLES =
  "py-12 px-6 text-center bg-[var(--color-surface)] border border-dashed " +
  "border-[var(--color-text-base)]/[0.07] rounded-[12px] mb-3";

export const EMPTY_STATE_ICON_STYLES = "text-[32px] mb-3 opacity-40";
export const EMPTY_STATE_TEXT_STYLES = "text-xs text-[var(--color-muted)] font-mono mb-4";
...
export const MODAL_PANEL_STYLES =
  "bg-[var(--color-surface)] border border-[var(--color-text-base)]/[0.14] rounded-2xl p-8 w-[400px] " +
  "animate-[fadeUp_0.2s_ease]";

export const MODAL_TITLE_STYLES =
  "font-['Syne',sans-serif] font-bold text-xl text-[var(--color-text-base)] mb-1.5";

export const MODAL_SUBTITLE_STYLES =
  "text-[11px] text-[var(--color-muted)] font-mono mb-6";
...
export const NAVBAR_LOGO_TEXT_STYLES =
  "font-['Syne',sans-serif] font-extrabold text-lg tracking-tight text-[var(--color-text-base)]";

export const NAVBAR_USER_CHIP_STYLES =
  "flex items-center gap-2 px-3 py-1.5 bg-[var(--color-surface2)] " +
  "border border-[var(--color-text-base)]/[0.07] rounded-full text-xs font-mono text-[var(--color-text-base)] cursor-pointer";
...
export const PAGE_TITLE_STYLES =
  "font-['Syne',sans-serif] font-extrabold text-5xl tracking-[-2px] leading-none text-[var(--color-text-base)]";

export const PAGE_SUBTITLE_STYLES =
  "text-[var(--color-muted)] text-xs mt-2 tracking-wide font-mono";

export const BACK_LINK_STYLES =
  "inline-flex items-center gap-1.5 text-xs text-[var(--color-muted)] font-mono " +
  "hover:text-[var(--color-text-base)] transition-colors cursor-pointer mb-8";
...
export const FOOTER_STYLES =
  "text-center py-6 text-[10px] text-[var(--color-muted)] tracking-widest font-mono " +
  "border-t border-[var(--color-text-base)]/[0.07]";
