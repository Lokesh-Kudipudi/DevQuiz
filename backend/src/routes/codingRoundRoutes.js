...
router.put('/:id/questions/:questionId/start', protect, startQuestionTimer);
router.put('/:id/questions/:questionId/pause', protect, pauseQuestionTimer);
router.post('/:id/submit-external', protect, submitExternalQuestion);
